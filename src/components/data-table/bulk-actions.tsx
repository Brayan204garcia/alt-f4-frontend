...
export function DataTableBulkActions<TData>({
  ...
  useEffect(() => {
    if (selectedCount > 0) {
      const message = `${selectedCount} ${entityName}${selectedCount > 1 ? 's' : ''} seleccionados. La barra de acciones esta disponible.`
  ...
  return (
    <>
      ...
      <div
        ref={toolbarRef}
        role='toolbar'
        aria-label={`Acciones para ${selectedCount} ${entityName}${selectedCount > 1 ? 's' : ''} seleccionados`}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                title='Limpiar seleccion (Escape)'
              >
                <X />
                <span className='sr-only'>Limpiar seleccion</span>
              </Button>
            </TooltipTrigger>
            <TooltipContent>
              <p>Limpiar seleccion (Escape)</p>
            </TooltipContent>
          </Tooltip>
